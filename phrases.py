...
ANTI_CORRUPTION = """
    ...
    "A hot potato".
"""
YOU_ARE_REVOLUTIONER = """
    This goal will be achieved in the near future by revolution.
"""
...
-----------------------------------------------------------------
	[1] You might want to use this situation
		...
		to choice type: "I got the military help." and ENTER
------------------------------------------------------------------
...
DEAL_WITH_RADICALS = """
    ...
    But the special services disclosed the preparation 
    of the revolution, all participants are arrested.
"""
DICTATOR = """
...
"""
SECOND_ELECTION_INTRODUCTION = """
    You got to the second round of the presidential election. 
    This is almost a victory, but to relax early. 
    It's possible to lose everything, too.
    You can choose from three tactics:
----------------------------------------------------------    
[1] To distribute unrealistic promises to voters,
    such as halving taxes, raising the minimum wage 10 times,
    cutting utility tariffs 2 times, creating 3 million new jobs
    in the first year, building 100,000 kilometers of roads,
    50 modern hospitals , eradicate corruption, and so on.
    You do not resort to the black PR of competitors
    and do not conclude deals with them.

    to choice type: 
    "I can promise voters everything they want to hear!" and ENTER
----------------------------------------------------------    
[2] I use black PR against the opponent at the last stage.

    to choice type: 
    "I use black PR!" and ENTER
----------------------------------------------------------    
[3] You understand that the chances of victory 
    the second round and losing more than winning,
    therefore accept the offer of opponent
    and not to go to the second round, but to recognize victory
    in exchange for the post of prime minister. 
    
    to choice type: "I made deal with opponent!" and ENTER    
----------------------------------------------------------
"""
